...
import { Tabs, Tab, Stack, Typography, Button, Container } from '@mui/material';
import SkladSortirovki from '../SkladSortirovki';
import SkladGP from '../SkladGP';
import Inventarizaciya from '../Inventarizaciya';
import VProizvodstve from '../VProizvodstve';
import { PiMicrosoftExcelLogo } from 'react-icons/pi';
    ...
    <div>
      <Container>
        ...
        <Tabs value={activeTab} onChange={handleTabChange}>
          ...
          <Tab label="Склад сортировки" />
          <Tab label="Склад ГП" />
          <Tab label="Инвентаризация" />
        </Tabs>

        {activeTab === 0 && <VProizvodstve />}
        {activeTab === 1 && <SkladSortirovki />}
        {activeTab === 2 && <SkladGP />}
        {activeTab === 3 && <Inventarizaciya />}
      </Container>
    </div>
  );
};
